...
class SkyWars extends PluginBase implements Listener {
    ...
    public $Signprefix = TextFormat::BLUE . "SkyWars";
    public $prefix = TextFormat::BLUE . "SkyWars" . TextFormat::DARK_GRAY . " | " . TextFormat::GRAY;
    public $arenas = array();
    ...
    public function onEnable() {
        ...
        if ($config->get("arenas") == null) {
            $config->set("arenas", array("SkyWars"));
            $config->save();
        }
        $items = array(
...
class SWRefreshSigns extends Task {
...
class SWGameSender extends Task {
